...
const Footer = () => (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flow-col mb-8 w-full`}>
      ...
      <div className="w-full flex justify between item-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3r45]">
